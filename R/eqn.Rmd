...
rope(Bass.Pheno.SVL.Growth.diff, ci = 0.95)
plot(p_direction(Bass.Pheno.SVL.Growth.diff))
PD.Pheno.SVL.Growth.diff <- p_direction(Bass.Pheno.SVL.Growth.diff)
pd_to_p(PD.Pheno.SVL.Growth.diff, direction = "two-sided")
# H2: Like Genotype Hypothesis
...
rope(Bass.Pheno.Mass.Growth.diff, ci = 0.95)
plot(p_direction(Bass.Pheno.Mass.Growth.diff))
PD.Pheno.Mass.Growth.diff <- p_direction(Bass.Pheno.Mass.Growth.diff)
pd_to_p(PD.Pheno.Mass.Growth.diff, direction = "two-sided")
# H2: Like Genotype Hypothesis
...
rope(Pog.Pheno.SVL.Growth.diff, ci = 0.95)
plot(p_direction(Pog.Pheno.SVL.Growth.diff))
PD.Pheno.SVL.Growth.diff <- p_direction(Pog.Pheno.SVL.Growth.diff)
pd_to_p(PD.Pheno.SVL.Growth.diff, direction = "two-sided")
# H2: Like Genotype Hypothesis
Pog.Geno.mass.diff.m1 <-  ZZm.SVL.Growth.posterior - ZZf.SVL.Growth.posterior 
rope(Pog.Geno.mass.diff.m1, ci = 0.95)
plot(p_direction(Pog.Geno.mass.diff.m1))
pd.geno.mass.m1 <- p_direction(Pog.Geno.mass.diff.m1)
pd_to_p(pd.geno.mass.m1, direction = "two-sided")
...
rope(Pog.Pheno.Mass.Growth.diff, ci = 0.95)
plot(p_direction(Pog.Pheno.Mass.Growth.diff))
PD.Pheno.Mass.Growth.diff <- p_direction(Pog.Pheno.Mass.Growth.diff)
pd_to_p(PD.Pheno.Mass.Growth.diff, direction = "two-sided")
# H2: Like Genotype Hypothesis
...
Bas_m1_brms <- readRDS(file = "~/Dropbox/energy_sex_reversal/models/Bas_m1_brms")
post_Bas_m1 <- posterior_samples(Bas_m1_brms, pars = "^b")
XXf.MR.mass.posterior <- as.array( post_Bas_m1[,"b_zlogMass"])
XXm.MR.mass.posterior <- as.array(XXf.MR.mass.posterior +  post_Bas_m1[,"b_sexXXm:zlogMass"]) # sex reversed
XYm.MR.mass.posterior <- as.array(XXf.MR.mass.posterior +  post_Bas_m1[,"b_sexXYm:zlogMass"])
# H1: Like Phenotype Hypothesis
...
Bass.Pheno.MR.post <- describe_posterior(Bass.Pheno.MR, estimate = "median",
                                                   ...
                                                   test = c("pd"))
# "p value" 0.37
Bass.Pheno.MR.post.PD <- pd_to_p(p_direction(Bass.Pheno.MR), direction = "two-sided")
Bass.Pheno.MR.post$"p value" = "p > 0.05"
Bass.Pheno.MR.post[1,1] = "Pheotype"
# H2: Like Genotype Hypothesis
...
Bass.Geno.MR.post <- describe_posterior(Bass.Geno.MR, estimate = "median",
                                                   ...
                                                   test = c("pd"))
# "p value" <0.01
Bass.Geno.MR.post.PD <- pd_to_p(p_direction(Bass.Geno.MR), direction = "two-sided")
Bass.Geno.MR.post$"p value" = "p < 0.01"
Bass.Geno.MR.post[1,1] = "Genotype"
# final MR df
...
Bass.Pheno.SVL.post <- describe_posterior(Bass.Pheno.SVL, estimate = "median",
                                                   ...
                                                   test = c("pd"))
# p value 0.25
Bass.Pheno.SVL.post.PD <- pd_to_p(p_direction(Bass.Pheno.SVL), direction = "two-sided")
Bass.Pheno.SVL.post$"p value" = "p > 0.05"
Bass.Pheno.SVL.post[1,1] = "Pheotype"
# H2: Like Genotype Hypothesis
...
Bass.Geno.SVL.post <- describe_posterior(Bass.Geno.SVL, estimate = "median",
                                                   ...
                                                   test = c("pd"))
# "p value" <0.36
Bass.Geno.SVL.post.PD <- pd_to_p(p_direction(Bass.Geno.SVL), direction = "two-sided")
Bass.Geno.SVL.post$"p value" = "p > 0.05"
Bass.Geno.SVL.post[1,1] = "Genotype"
# final SVL df
...
Bass.Pheno.Mass.post <- describe_posterior(Bass.Pheno.Mass, estimate = "median",
                                                   ...
                                                   test = c("pd"))
# "p value" 0.75
Bass.Pheno.Mass.post.pd <- pd_to_p(p_direction(Bass.Pheno.Mass), direction = "two-sided")
Bass.Pheno.Mass.post$"p value" = "p > 0.05"
Bass.Pheno.Mass.post[1,1] = "Pheotype"
# H2: Like Genotype Hypothesis
...
Bass.Geno.Mass.post <- describe_posterior(Bass.Geno.Mass, estimate = "median",
                                                   ...
                                                   test = c("pd"))
# "p value" 0.25
Bass.Geno.Mass.post.pd <- pd_to_p(p_direction(Bass.Geno.Mass), direction = "two-sided")
Bass.Geno.Mass.post$"p value" = "p > 0.05"
Bass.Geno.Mass.post[1,1] = "Genotype"
# final MR df
...
Pog_m2_brms <- readRDS(file = "~/Dropbox/energy_sex_reversal/models/Pog_m2_brms")
post_Pog_m2 <- posterior_samples(Pog_m2_brms, pars = "^b")
ZWf.MR.mass.posterior <- as.array( post_Pog_m2[,"b_sigma_zlogMass"])
ZZf.MR.mass.posterior <- as.array(ZWf.MR.mass.posterior +  post_Pog_m2[,"b_sexZZf:zlogMass"]) # sex reversed
ZZm.MR.mass.posterior <- as.array(ZWf.MR.mass.posterior +  post_Pog_m2[,"b_sexZZm:zlogMass"])
# H1: Like Phenotype Hypothesis
...
Pog.Pheno.MR.post <- describe_posterior(Pog.Pheno.MR, estimate = "median",
                                                   ci = .95, ci_method = "hdi",
                                                   test = c("pd"))
Pog.Pheno.MR.post[1,1] = "Pheotype"
# "p value" 0.05
Pog.Pheno.MR.post.pd <-pd_to_p(p_direction(Pog.Pheno.MR), direction = "two-sided")
Pog.Pheno.MR.post$"p value" = "p = 0.05"
# H2: Like Genotype Hypothesis
Pog.Geno.MR <- ZZf.MR.mass.posterior - ZZm.MR.mass.posterior
Pog.Geno.MR.post <- describe_posterior(Pog.Geno.MR, estimate = "median",
                                                   ci = .95, ci_method = "hdi",
                                                   test = c("pd"))
Pog.Geno.MR.post [1,1] = "Genotype"
# "p value" <0.01
Pog.Geno.MR.post.pd <-pd_to_p(p_direction(Pog.Geno.MR), direction = "two-sided")
Pog.Geno.MR.post$"p value" = "p < 0.01"
...
Pog.Pheno.SVL.post <- describe_posterior(Pog.Pheno.SVL, estimate = "median",
                                                   ...
                                                   test = c("pd"))
# "p value" 0.93
Pog.Pheno.SVL.post.pd <- pd_to_p(p_direction(Pog.Pheno.SVL), direction = "two-sided")
Pog.Pheno.SVL.post$"p value" = "p > 0.05"
Pog.Pheno.SVL.post[1,1] = "Pheotype"
# H2: Like Genotype Hypothesis
...
Pog.Geno.SVL.post <- describe_posterior(Pog.Geno.SVL, estimate = "median",
                                                   ...
                                                   test = c("pd"))
# "p value" <0.50
Pog.Geno.SVL.post.pd <- pd_to_p(p_direction(Pog.Geno.SVL), direction = "two-sided")
Pog.Geno.SVL.post$"p value" = "p > 0.05"
Pog.Geno.SVL.post[1,1] = "Genotype"
# final SVL df
...
Pog.Pheno.Mass.post <- describe_posterior(Pog.Pheno.Mass, estimate = "median",
                                                   ...
                                                   test = c("pd"))
# "p value" 0.38
Pog.Pheno.Mass.post.pd <- pd_to_p(p_direction(Pog.Pheno.Mass), direction = "two-sided")
Pog.Pheno.Mass.post$"p value" = "p > 0.05"
Pog.Pheno.Mass.post[1,1] = "Pheotype"
# H2: Like Genotype Hypothesis
...
Pog.Geno.Mass.post <- describe_posterior(Pog.Geno.Mass, estimate = "median",
                                                   ...
                                                   test = c("pd"))
# "p value" = 0.05
Pog.Geno.Mass.post.pd <- pd_to_p(p_direction(Pog.Geno.Mass), direction = "two-sided")
Pog.Geno.Mass.post$"p value" = "p = 0.05"
Pog.Geno.Mass.post[1,1] = "Genotype"
# final Mass df
...
Bass_sample_Size <- read.csv(file = "~/Dropbox/energy_sex_reversal/final.analysis.data/growth.bassiana.pogona.csv") %>% 
  ...
  # pd estimates from pairwise comparisons XXm - XYm = 0.78; XXf - XXm = 0.91; XYm - XXf = 0.7
  mutate("Contrast" = c("XXf-XXm","XXm-XYm", "XYm-XXf"), 
         "pd value" = c("0.78", "0.91", "0.70"),
         "p value" = "P>0.05")
# bass final table
...
TableS1  <-  TableS1[,c(10,11,2,7,8,9,3,4,5)]
